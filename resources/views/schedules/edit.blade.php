...
@section('content')
<div class="container">
    <h1>Editar Horario de Médico</h1>
    <form method="POST" action="{{ route('schedules.update', $schedule->id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="day" id="day" class="form-control" value="{{ $schedule->day }}" required>
        ...
        <div class="mb-3">
            ...
            <select name="status" id="status" class="form-control" required>
                <option value="activo" {{ $schedule->status == 'activo' ? 'selected' : '' }}>Activo</option>
                <option value="inactivo" {{ $schedule->status == 'inactivo' ? 'selected' : '' }}>Inactivo</option>
            </select>
